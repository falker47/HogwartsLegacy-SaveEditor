...
class App(BaseWindow):
    ...
    def _find_dll_deep_search(self) -> bool:
        ...
        # Force UI update if possible, though strict update() is removed for thread safety
        # Since this runs in init (main thread), we can update idletasks
        try:
             self.update_idletasks()
        except: pass
    ...
    def _verify_required_files(self) -> bool:
        ...
        while True:
            ...
            msg = (
                ...
                "Click 'No' to SEARCH your PC for the file (May take time)\n"
